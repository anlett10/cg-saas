...
// ../../node_modules/.bun/color2k@2.0.3/node_modules/color2k/dist/index.exports.import.es.mjs
...
__name(createBentoAltTemplates, "createBentoAltTemplates");
var bentoGrandChildrenThemes = {
...
__name(createBentoChildrenThemes, "createBentoChildrenThemes");
function createTakeoutThemes() {
...
var createInterFont = /* @__PURE__ */ __name((font = {}, {
  ...
  return createFont2({
    ...
    lineHeight: Object.fromEntries(Object.entries(size2).map(([k, v]) => [k, sizeLineHeight(getVariableValue2(v))])),
    weight: {
      4: "300"
    },
    letterSpacing: {
...
var body = createInterFont();
var heading = createInterFont({
  face: {
    700: { normal: "InterBold" }
  }
});
var mono = createSystemFont({
  sizeLineHeight: /* @__PURE__ */ __name((size2) => size2 >= 16 ? size2 * 1.2 + 8 : size2 * 1.15 + 5, "sizeLineHeight"),
  font: {
